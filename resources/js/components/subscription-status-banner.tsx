...
export function SubscriptionStatusBanner({ subscription }: SubscriptionStatusBannerProps) {
    ...
    if (subscription.on_trial && subscription.days_until_expiry <= 3 && subscription.days_until_expiry > 0) {
        return (
    ...
    if (subscription.on_grace_period && subscription.days_until_expiry > 0) {
        return (
