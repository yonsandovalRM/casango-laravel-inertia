export const bookings = {
    en: {
        bookings: {
            ...
            client: {
                title: 'My Bookings',
                description: 'Manage and synchronize your bookings',
            },
            professional: {
            ...
            show: {
                ...
                client_section: {
                    ...
                    date: 'Booking Date',
                    date_time: 'Booking Date and Time',
    ...
    es: {
        bookings: {
            ...
            client: {
                title: 'Mis Reservas',
                description: 'Gestiona y sincroniza tus citas',
            },
            professional: {
                title: 'Reservas Profesional',
                description: 'Gestiona y sincroniza tus citas',
            },
            index: {
                title: 'Reservas',
            ...
            show: {
                ...
                client_section: {
                    ...
                    description: 'Ver y gestionar los detalles de la reserva',
                    client_name: 'Nombre del Cliente',
                    date: 'Fecha de la Reserva',
                    date_time: 'Fecha y Hora de la Reserva',
                    booking_status: 'Reserva',
                    notes: 'Notas',
                ...
                client_profile: {
                    ...
                    description: 'Ficha de información del Cliente',
                },
                booking_information: {
                    title: 'Registro',
